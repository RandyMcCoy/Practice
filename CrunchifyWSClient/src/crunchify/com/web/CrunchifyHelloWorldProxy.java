...
public class CrunchifyHelloWorldProxy implements crunchify.com.web.CrunchifyHelloWorld {
  private String _endpoint = null;
  private crunchify.com.web.CrunchifyHelloWorld crunchifyHelloWorld = null;
  ...
  private void _initCrunchifyHelloWorldProxy() {
    try {
      crunchifyHelloWorld = (new crunchify.com.web.CrunchifyHelloWorldServiceLocator()).getCrunchifyHelloWorld();
  ...
  public crunchify.com.web.CrunchifyHelloWorld getCrunchifyHelloWorld() {
    if (crunchifyHelloWorld == null)
      _initCrunchifyHelloWorldProxy();
