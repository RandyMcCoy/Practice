...
public class CrunchifyHelloWorldServiceLocator extends org.apache.axis.client.Service implements crunchify.com.web.CrunchifyHelloWorldService {
    ...
    public crunchify.com.web.CrunchifyHelloWorld getCrunchifyHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            crunchify.com.web.CrunchifyHelloWorldSoapBindingStub _stub = new crunchify.com.web.CrunchifyHelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (crunchify.com.web.CrunchifyHelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                crunchify.com.web.CrunchifyHelloWorldSoapBindingStub _stub = new crunchify.com.web.CrunchifyHelloWorldSoapBindingStub(new java.net.URL(CrunchifyHelloWorld_address), this);
                _stub.setPortName(getCrunchifyHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.com.crunchify", "CrunchifyHelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.com.crunchify", "CrunchifyHelloWorld"));
        }
