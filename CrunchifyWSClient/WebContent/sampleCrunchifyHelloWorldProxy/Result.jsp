...
<jsp:useBean id="sampleCrunchifyHelloWorldProxyid" scope="session" class="crunchify.com.web.CrunchifyHelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        crunchify.com.web.CrunchifyHelloWorld getCrunchifyHelloWorld10mtemp = sampleCrunchifyHelloWorldProxyid.getCrunchifyHelloWorld();
